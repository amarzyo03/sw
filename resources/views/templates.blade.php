...
<head>
    ...
    <!-- Vendors styles-->
    <link rel="stylesheet" href="/node_modules/simplebar.css">
...
<body>
        ...
        <header class="header header-sticky p-0 mb-4">
            <div class="container-fluid border-bottom px-4">
                ...
                <ul class="header-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="#">
                            <svg class="icon icon-lg">
                                <use xlink:href="/node_modules/free.svg#cil-list-rich"></use>
                            </svg></a></li>
                    <li class="nav-item"><a class="nav-link" href="#">
                            <svg class="icon icon-lg">
                ...
                <ul class="header-nav">
                    ...
                    <li class="nav-item dropdown">
                        <button class="btn btn-link nav-link py-2 px-2 d-flex align-items-center" type="button"
                            ...
                            <svg class="icon icon-lg theme-icon-active">
                                <use xlink:href="/node_modules/free.svg#cil-contrast"></use>
                            </svg>
                        </button>
                            ...
                            <li>
                                <button class="dropdown-item d-flex align-items-center" type="button"
                                    ...
                                    <svg class="icon icon-lg me-3">
                                        <use xlink:href="/node_modules/free.svg#cil-sun"></use>
                                    </svg>Light
                                </button>
                            </li>
                            <li>
                                <button class="dropdown-item d-flex align-items-center" type="button"
                                    ...
                                    <svg class="icon icon-lg me-3">
                                        <use xlink:href="/node_modules/free.svg#cil-moon"></use>
                                    </svg>Dark
                                </button>
                            </li>
                            <li>
                                <button class="dropdown-item d-flex align-items-center active" type="button"
                                    ...
                                    <svg class="icon icon-lg me-3">
                                        <use xlink:href="/node_modules/free.svg#cil-contrast">
                                        </use>
                                    </svg>Auto
                                </button>
                            </li>
                    ...
                    <li class="nav-item dropdown"><a class="nav-link py-0 pe-0" data-coreui-toggle="dropdown"
                            ...
                            <div class="avatar avatar-md"><img class="avatar-img" src="/assets/img/user.png"
                        ...
                        <div class="dropdown-menu dropdown-menu-end pt-0">
                            ...
                            <a href="{{ session()->has('admin_id') ? '/logout' : (session()->has('siswa_id') ? '/user-siswa/logout' : '') }}"
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb my-0">
                        <li class="breadcrumb-item">
                            <a class="text-decoration-none" href="{{ url('/') }}">Home</a>
                        </li>
                        @foreach ($segments as $index => $segment)
                            @php
                                $url .= '/' . $segment;
                                $formatted = ucwords(str_replace(['-', '_'], ' ', $segment));
                            @endphp
                            @if ($index + 1 < count($segments))
                                <li class="breadcrumb-item">
                                    <a class="text-decoration-none" href="{{ url($url) }}">{{ $formatted }}</a>
                                </li>
                            @else
    ...
    <script src="/node_modules/coreui.bundle.min.js"></script>
    <script src="/node_modules/simplebar.min.js"></script>
    <script>
