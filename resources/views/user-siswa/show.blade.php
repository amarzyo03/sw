                ...
                <div class="col-md-8">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control-plaintext" id="nama" name="nama"
                                value="{{ ucwords($siswa->nama) }}" disabled>
                        </div>
                    </div>
                            ...
                            <div class="row g-2">
                                <div class="col-sm-6">
                                    <input type="text" class="form-control-plaintext mb-2" id="tempat_lahir"
                                        name="tempat_lahir" value="{{ ucwords($siswa->tempat_lahir) }}" disabled>
                                </div>
                                <div class="col-sm-6">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control-plaintext" id="tanggal_lahir" name="tanggal_lahir"
                                value="{{ ucwords($siswa->agama) }}" disabled>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control-plaintext" id="alamat" name="alamat" rows="3" placeholder="Masukkan Alamat"
                                disabled>{{ ucwords($siswa->alamat) }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-9 offset-sm-3">
                            <a href="/user-siswa/edit" class="btn btn-primary w-25">Edit</a>
                            <a href="/user-siswa/dashboard" class="btn btn-danger">Batal</a>
                        </div>
                    </div>
